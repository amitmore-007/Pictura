...
const EditFolderModal = ({ isOpen, onClose, onSubmit, folder, loading }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Form reset and modal close handled by parent component
    } catch (error) {
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className={`block w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-colors ${
                    errors.name
